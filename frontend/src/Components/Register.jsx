...
function Register() {
  return (
    <div className="relative w-full h-full min-h-screen flex items-center justify-center bg-[#01062a] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center bg-white dark:bg-gray-900 p-8 rounded-xl shadow-lg glowing-shadow">
        ...
        <form action="#" method="post" className="space-y-4">
          ...
          <div className="mb-4">
            ...
            <input
              id="password"
              className="border p-3 shadow-md dark:bg-indigo-700 dark:text-gray-300 dark:border-gray-700 placeholder:text-base focus:scale-105 ease-in-out duration-300 border-gray-300 rounded-lg w-full mb-6"
              type="password"
